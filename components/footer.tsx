...
import { ArrowUpRight, ChevronUp, Facebook, Instagram, Linkedin, Mail, MapPin, Mountain, Phone, Shield, ShieldCheck, Zap, Globe, Cpu, Clock } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-transparent pb-14 pt-20 font-sans md:pb-20 md:pt-40">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-12 border-b border-white/5 pb-16 md:pb-28 lg:grid-cols-12 lg:gap-20">
          ...
          <div className="space-y-10 lg:col-span-5">
            <div className="flex items-start gap-6 sm:items-center">
              ...
              <div>
                <h4 className="font-display text-2xl font-bold uppercase tracking-[0.3em] text-white">
                  Kaimanawa
                </h4>
                <p className="text-[10px] font-black uppercase tracking-[0.45em] text-gold-400/60">
          ...
          <div className="lg:col-span-3">
            <h5 className="mb-10 text-[10px] font-black uppercase tracking-[0.6em] text-gold-400/30 border-l border-gold-400/30 pl-4">
              Navigation Archive
            </h5>
            <ul className="grid gap-5">
              {[
                ...
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="group flex items-center gap-4 text-[11px] font-bold uppercase tracking-[0.25em] text-gray-400 transition-all hover:translate-x-3 hover:text-gold-300"
                  >
          ...
          <div className="lg:col-span-4 flex flex-col gap-10">
            <h5 className="text-[10px] font-black uppercase tracking-[0.6em] text-gold-400/30 border-l border-gold-400/30 pl-4">
              Operational Contact
            </h5>
            <div className="space-y-8">
              <div className="group flex items-center gap-6">
                ...
                <div className="min-w-0">
                  <p className="mb-1 text-[9px] font-black uppercase tracking-[0.4em] text-white/20">
        ...
        {/* BOTTOM COMMAND BAR */}
        <div className="mt-12 flex flex-col gap-10 md:mt-20 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:gap-14">
            ...
            <div className="flex items-center gap-4 rounded-full border border-gold-500/10 bg-gold-400/5 px-6 py-2.5 backdrop-blur-3xl shadow-glow">
              <ShieldCheck className="h-4 w-4 text-gold-400/60" />
              <span className="text-[9px] font-black uppercase tracking-[0.35em] text-gold-300/80">
          ...
          <div className="flex items-center gap-12 lg:gap-20">
             ...
             <div className="group flex items-center gap-5">
               <div className="text-right">
                 <p className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 leading-none group-hover:text-gold-400 transition-colors">
        ...
        <div className="mx-auto mt-16 max-w-4xl text-center md:mt-24 border-t border-white/5 pt-12">
          <p className="text-[10px] uppercase tracking-[0.25em] leading-relaxed text-white/10 sm:tracking-[0.4em]">
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="group fixed bottom-8 right-8 z-[100] flex h-16 w-16 items-center justify-center rounded-2xl border border-gold-400/30 bg-black/80 text-gold-400 shadow-glow backdrop-blur-3xl transition-all hover:bg-gold-400 hover:text-black active:scale-95"
          >
