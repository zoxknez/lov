...
export default function SignatureReveal({ daylight, isNight }: SignatureRevealProps) {
  return (
    <section className={`section-shell signature-shell signature-shell-tight signature-phase relative z-10 ${isNight ? "is-night" : "is-day"}`}>
      ...
      <div className="signature-heading premium-panel rounded-2xl bg-black/35 p-4">
        <p className="text-xs uppercase tracking-[0.2em] text-[#d9b167]">Signature Reveal</p>
        <h2 className="font-serif text-4xl md:text-5xl">Layered cinematic frames</h2>
      </div>
          ...
          >
            <div className="relative h-full overflow-hidden rounded-2xl">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-[10px] uppercase tracking-[0.15em] text-[#dfc28f]">Sequence 0{idx + 1}</p>
